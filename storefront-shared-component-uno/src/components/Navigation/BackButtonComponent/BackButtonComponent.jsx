...
import styles3 from "../NavigationRouteWraper/NavigationRouteWraper.module.css"
import { GlobalStore } from "redux-micro-frontend";
import styles2 from "../NavigationWrapper/NavigationWrapper.module.css";
  ...
  return (
    <>
      <button className={styles.flits_back_btn} onClick={handleBackClick}>
        ...
        {t("flits.buttons.back")}
      </button>
      <span className={styles.flits_tab_box_title}>
        {t(props?.label[0], props?.label?.length > 1 ? props?.label[1] : "")}
      </span>
