...
import styles from "./MyProfileSelect.module.css";
...
export const MyProfileSelect = (props) => {
  ...
  return (
    <div className={styles.flits_select_row}>
      ...
      >
        <option value="" className={styles.flits_d_none} disabled={props?.edit}>{props?.edit ? t("flits.profile_page.select_gender_placeholder", "Select a gender") : null}</option>
