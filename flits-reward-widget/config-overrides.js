...
const moduleOverride = {
  name: "flitsRewardWidget",
  filename: `assets/flits_reward_widget.${
    process.env.REACT_APP_CODE_BUILD_VERSION ?? ""
  }.js`,
  exposes: {},
  remotes: {},
  shared: {
...
const configOutputOverRide = {
  chunkFilename: `assets/[name].[contenthash:8].flitsRewardWidget.${
    process.env.REACT_APP_CODE_BUILD_VERSION ?? ""
  }.chunk.js`,
  filename: `assets/main.flitsRewardWidget.${
    process.env.REACT_APP_CODE_BUILD_VERSION ?? ""
  }.js`,
...
const cssPaths = {
  filename: `assets/[name].[contenthash:8].flitsRewardWidget.${
    process.env.REACT_APP_CODE_BUILD_VERSION ?? ""
  }.css`,
  chunkFilename: `assets/[name].[contenthash:8].flitsRewardWidget.${
    process.env.REACT_APP_CODE_BUILD_VERSION ?? ""
