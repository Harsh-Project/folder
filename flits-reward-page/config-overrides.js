...
const moduleOverride = {
  name: "cap-container",
  filename: `assets/flits_reward_page.${
...
const configOutputOverRide = {
  chunkFilename: `assets/[name].[contenthash:8].flitsRewardPage.${
    process.env.REACT_APP_CODE_BUILD_VERSION ?? ""
  }.chunk.js`,
  filename: `assets/main.flitsRewardPage.${
    process.env.REACT_APP_CODE_BUILD_VERSION ?? ""
  }.js`,
...
const cssPaths = {
  filename: `assets/[name].[contenthash:8].flitsRewardPage.${
    process.env.REACT_APP_CODE_BUILD_VERSION ?? ""
  }.css`,
  chunkFilename: `assets/[name].[contenthash:8].flitsRewardPage.${
    process.env.REACT_APP_CODE_BUILD_VERSION ?? ""
