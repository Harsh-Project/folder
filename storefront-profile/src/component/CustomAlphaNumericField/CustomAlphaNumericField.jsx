...
export const CustomAlphaNumericField = ({ item }) => {
  ...
  const MyProfileCustomAlphaNumericField =
    window.UnoDuoComponent("MyProfileCustomAlphaNumericField");
  ...
  if (!MyProfileLabel || !MyProfileCustomAlphaNumericField) return null;
  return (
    <MyProfileCustomRow edit={edit} index={item?.unique_id}>
      <MyProfileLabel
        ...
        wrapText={true}
      />
      <MyProfileCustomAlphaNumericField
        readOnly={!edit}
