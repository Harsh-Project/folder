...
export const CustomTextField = ({ item }) => {
  ...
  const MyProfileCustomTextField = window.UnoDuoComponent(
    "MyProfileCustomTextField"
  );
  ...
  const handleChange = useCallback(
    ...
    [item, updateCustomFieldState, validateField]
  );

  if (!MyProfileLabel || !MyProfileCustomTextField) return null;
