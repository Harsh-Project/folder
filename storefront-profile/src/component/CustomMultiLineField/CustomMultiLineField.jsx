...
export const CustomMultiLineField = ({ item }) => {
  ...
  const MyProfileCustomMultiLineField = window.UnoDuoComponent(
    "MyProfileCustomMultiLineField"
  );
  ...
  if (!MyProfileLabel || !MyProfileCustomMultiLineField) return null;
