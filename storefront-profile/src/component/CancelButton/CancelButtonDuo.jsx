...
export const CancelButtonDuo = ({ item }) => {
  ...
  const MyProfileCancelButton =
    window.UnoDuoComponent("MyProfileCancelButton");
  ...
  if (!MyProfileCancelButton) return null;

  return (
    edit && (
      <MyProfileCancelButton
        type={item?.type}
