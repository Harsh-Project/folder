...
const moduleOverride = {
  ...
  filename: `assets/storeFront_myProfile.${process.env.REACT_APP_CODE_BUILD_VERSION ?? ""}.js`,
  exposes: {
    "./storeFrontMyProfile": "./src/App.js",
    "./storeFrontRegisterPageCustomFields": "./src/component/RegisterPageCustomFields/RegisterPageCustomFields.jsx",
  },
  remotes: {
  },
  shared: {
...
const configOutputOverRide = {
  chunkFilename: `assets/[name].[contenthash:8].storeFrontMyProfile.${process.env.REACT_APP_CODE_BUILD_VERSION ?? ""}.chunk.js`,
  filename: `assets/[name].[contenthash:8].storeFrontMyProfile.${process.env.REACT_APP_CODE_BUILD_VERSION ?? ""}.js`,
  // chunkFormat: "commonjs",
  publicPath: "auto",
  path: path.resolve(__dirname, "build")
};
const cssPaths = {
  filename: `assets/[name].[contenthash:8].storeFrontMyProfile.${process.env.REACT_APP_CODE_BUILD_VERSION ?? ""}.css`,
  chunkFilename: `assets/[name].[contenthash:8].storeFrontMyProfile.${process.env.REACT_APP_CODE_BUILD_VERSION ?? ""}.chunk.css`,
}
