...
const moduleOverride = {
  ...
  filename: `assets/storeFront_wishList.${process.env.REACT_APP_CODE_BUILD_VERSION ?? ""}.js`,
  exposes: {
    "./storeFrontWishList": "./src/App.js",
    "./storeFrontWishListPage": "/src/WishListCustomerPage.js",
    "./storeFrontWishListCollection": "./src/WishListCollection.js"
  },
  remotes: {  },
  shared: {
    ...dependencies,
...
const configOutputOverRide = {
  chunkFilename: `assets/[name].[contenthash:8].storeFrontWishList.${process.env.REACT_APP_CODE_BUILD_VERSION ?? ""}.chunk.js`,
  filename: `assets/[name].[contenthash:8].storeFrontWishList.${process.env.REACT_APP_CODE_BUILD_VERSION ?? ""}.js`,
  // chunkFormat: "commonjs",
  publicPath: "auto",
  path: path.resolve(__dirname, "build")
};
const cssPaths = {
  filename: `assets/[name].[contenthash:8].storeFrontWishList.${process.env.REACT_APP_CODE_BUILD_VERSION ?? ""}.css`,
  chunkFilename: `assets/[name].[contenthash:8].storeFrontWishList.${process.env.REACT_APP_CODE_BUILD_VERSION ?? ""}.chunk.css`,
}
