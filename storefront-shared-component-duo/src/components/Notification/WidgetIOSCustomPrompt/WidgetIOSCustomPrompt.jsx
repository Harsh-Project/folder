    ...
    >
      <div className={styles.flits_description}>
        <div className={styles.flits_title}>
          <h2 className={styles.flits_title_h2}>
            {data?.ios_title}
          </h2>
          <p className={styles.flits_description_p} dangerouslySetInnerHTML={{__html: data?.ios_description?.replaceAll("##share_icon##", shareSvg)}}>
          </p>
        </div>
      </div>
    </Modal>
