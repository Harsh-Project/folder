...
import styles from "./ContactUsModalModule.module.css";
  ...
  return (
    ...
    >
      <div className={styles.flits_popup_icon_text}>
        <div className={styles.flits_popup_icon}><RenderSvgString svgString={window?.DuoIcon?.Contactus} /></div>
      ...
      <div className={styles.flits_form_content}>
        ...
        >
          ...
          <button
            ...
            type="button"
          >
            {t("flits.order_contact_us.submit_button", "Submit")}
          </button>
          <Suspense fallback={<></>}>
