...
import styles from "./MyOrderContentWrapperModule.module.css";
...
export const MyOrderContentWrapper = (props) => {
  ...
  return (
    <>
      <div
        className={`${styles.flits_navigation_header} ${styles.flits_with_box_shadow}`}
      >
        <a
      ...
      <div
        className={`${styles.flits_container_box} ${styles.flits_px_15} ${styles.flits_pb_15} ${styles.flits_mt_25}`}
      >
