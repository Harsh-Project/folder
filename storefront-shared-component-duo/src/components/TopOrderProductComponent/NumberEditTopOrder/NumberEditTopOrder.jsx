import styles from "./NumberEditTopOrderModule.module.css";
...
export const NumberEditTopOrder = (props) => {
  ...
  return (
    <div className={`${styles.flits_product_quantity} ${orderField[`${props?.item[0]?.product_id}Availabel`] === false ? styles.flits_disabled : ""}`}>
      <input
        type="text"
