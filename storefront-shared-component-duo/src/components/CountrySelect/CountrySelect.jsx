import styles from "./CountrySelectModule.module.css";
...
export const CountrySelect = ({ optionValue, handleCountryChange }) => {
  ...
  }, [firstTime, updateData, optionValue]);
  ...
  return (
    <div className={styles.flits_country_dropdown}>
      ...
      <div className={styles.flits_select_row}>
        <select onChange={handleSelectChange} className={styles.flits_input}>
          {window?.country_list.map((option, index) => (
            <option
              ...
              defaultValue={optionValue === option.countryName}
            >
