import styles from "./MyProfileCustomDateFieldModule.module.css";
...
export const MyProfileCustomDateField = (props) => {  
  ...
  return (
    <div className={styles.flits_datewrap}>
      <div className={styles.flits_dob_wrap}>
        ...
        data-unique-id={props?.name}
            ...
            required="required"
            className={`flits-input-height-selector ${styles.flits_input}  ${styles.day} ${
        ...
        <div
          className={`${styles.flits_select_row} ${styles.flits_mm_select} ${styles.flits_mx_10} ${props?.edit ? styles.flits_select_edit : ""}`}
        >
          <select
            disabled={props?.disabled}
