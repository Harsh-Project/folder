...
const moduleOverride = {
  name: 'storeFrontSharedComponentDuo',
  filename: `assets/store_front_shared_component_duo.${process.env.REACT_APP_CODE_BUILD_VERSION ?? ""}.js`,
  exposes: {
    "./SharedComponentDuo": "./src/components/index.jsx"
  },
  remotes: {
  },
  shared: {
...
const configOutputOverRide = {
  chunkFilename: `assets/[name].[contenthash:8].storeFrontSharedComponentDuo.${process.env.REACT_APP_CODE_BUILD_VERSION ?? ""}.chunk.js`,
  filename: `assets/[name].[contenthash:8].storeFrontSharedComponentDuo.${process.env.REACT_APP_CODE_BUILD_VERSION ?? ""}.js`,
  // chunkFormat: "commonjs",
  publicPath: "auto",
  path: path.resolve(__dirname, "build")
};
const cssPaths = {
  filename: `assets/[name].[contenthash:8].storeFrontSharedComponentDuo.${process.env.REACT_APP_CODE_BUILD_VERSION ?? ""}.css`,
  chunkFilename: `assets/[name].[contenthash:8].storeFrontSharedComponentDuo.${process.env.REACT_APP_CODE_BUILD_VERSION ?? ""}.chunk.css`,
}
